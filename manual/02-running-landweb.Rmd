...
manData <- file.path(prjDir, "manual", "ext_data")
fshp2 <- file.path(manData, "FMA_Boundary_Updated.shp")
fzip2 <- file.path(manData, "FMA_Boundary_Updated.zip")

if (!file.exists(fshp2)) {
  archive::archive_extract(fzip2, manData)
}
...
See [SpaDES.config/R/config.landweb.R](https://github.com/PredictiveEcology/SpaDES.config/blob/development/R/config.landweb.R).
