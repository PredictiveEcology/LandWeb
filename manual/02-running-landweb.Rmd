...
After having run several reps of the model on a given study area, results are combined in subsequent post-processing analyses to generate the following outputs for each set of rreporting polygons within the study area:
