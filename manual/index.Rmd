...
subtitle: "`r paste('v.', Sys.getenv('LANDWEB_MAN_VERSION'))`"
...
:::{.rmdimportant}
This manual is a live document which is automatically updated as changes are made to to underlying model code and documentation.
:::
...
If available, archived copies of previous manual versions are available from the links below.
