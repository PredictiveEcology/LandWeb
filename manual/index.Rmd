...
date: "`r Sys.Date()`"
description: "User manual for the LandWeb simulation model."
...
Archived copies of previous manual versions are listed on the [archive page](archive/).
That page is generated from the PDFs actually published, so it cannot fall out of step with them.
