...
:::{.rmdwarning}
If creating `~/.Renviron` using a text editor, be sure to save it *without* a `.txt` extension.
Windows users in particular should ensure they edit this file via Rstudio per above, or use a proper text editor, e.g., `Notepad++` (<https://notepad-plus-plus.org/downloads/>).
:::
