...
biomassMap <- raster(file.path("~", "GitHub", "LandWeb","landWebDataPrep", "data",
...
LCC05 <- raster(file.path(curDir, "landWebDataPrep", "data",
                               "LCC2005_V1_4a.tif"))
...
mySim <- simInit(times = times, params = parameters, modules = modules,
                 objects = objects, paths = paths, loadOrder = c("landWebDataPrep", "fireDataPrep", "initBaseMaps",  "fireNull", "landWeb_LBMRDataPrep", "LBMR"))
