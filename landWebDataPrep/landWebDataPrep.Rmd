...
shpStudyRegion <- Cache(shapefile, file.path(curDir,"landWebDataPrep", "data", "shpLandWEB.shp"),
...
modules <- list("landWebDataPrep", "initBaseMaps", "LandMine", "landWeb_LBMRDataPrep", "LBMR")
