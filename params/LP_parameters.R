...
## reproducible::showCache("cache/LP", userTags = "simInitAndExperiment")[tagKey=="cacheId"]$tagValue
...
## reproducible::showCache("cache/LP", userTags = "currentConditions")[tagKey=="cacheId"]$tagValue
# cacheId$currentConditions <- "a7b2adc999108768c8a889c6ea8d08f6"

## reproducible::showCache("cache/LP", userTags = "reportingAndLeadingFn")[tagKey=="cacheId"]$tagValue
# cacheId$ReportingAndLeadingFn <- "5acd6042606dddd6c7e5137827ae685b"

## reproducible::showCache("cache/LP", userTags = "leadingByStage")[tagKey=="cacheId"]$tagValue
# cacheId$leadingByStage <- "6d1230eb2c7623fd86718f11b48fc7aa"

## reproducible::showCache("cache/LP", userTags = "simInitAndSpades")[tagKey=="cacheId"]$tagValue
