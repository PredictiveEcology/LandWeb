...
test_dir("/Users/stevec/Documents/GitHub/LandWeb/initBaseMaps/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/Users/stevec/Documents/GitHub/LandWeb/initBaseMaps/tests/testthat/test-template.R")
