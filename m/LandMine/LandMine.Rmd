...
library(igraph)
library(SpaDES.core) # load also reproducible::Require
...
#################### OPTIMIZATION
outs <- DEoptim(fitSN, lower = c(0.01, 0.01, 1e3), upper = c(0.08, 0.04, 1e5), 
        control = DEoptim.control(VTR = 0.000001, itermax = 25, cluster = cl), 
