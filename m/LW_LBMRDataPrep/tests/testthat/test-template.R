...
# 2. Copy this file to the tests folder (i.e., `C:/Users/yonluo/Documents/GitHub/LandWeb/LW_LBMRDataPrep/tests/testthat`).

# 3. Modify the test description based on the content you are testing:
test_that("test Event1 and Event2.", {
  module <- list("LW_LBMRDataPrep")
  ...
  parameters <- list(
    ...
    LW_LBMRDataPrep = list(.saveInitialTime = NA)
  )
