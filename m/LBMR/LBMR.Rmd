...
Parameters for this module can be taken from a variety of sources. The default module downloads publically available vegetation layers from NRCAN servers, plus parameters developed by Boulanger et al. (2014). Default sources used by this module can be found here:
