test_that("test add new cohort function",{
  ...
  speciesEcoregion <- data.table(year = 0, maxANPP = c(886L, 1175L, 1106L, 1202L, 1202L, 1202L, 969L, 1130L,
                                                       1017L, 1090L, 1078L, 1096L, 1017L, 1090L, 1078L, 1096L),
                                 maxB = c(26580L, 32880L, 32880L, 32880L, 32880L, 32880L, 29070L, 32880L, 30510L, 
                                          32880L, 32340L, 32880L, 30510L, 32700L, 32340L, 32880L), 
                                 ecoregionGroup = 1L,
                                 speciesCode = 1:16)
  objects <- list()
