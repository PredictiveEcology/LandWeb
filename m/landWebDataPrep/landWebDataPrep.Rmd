...
This module is higher level data preparation for fire modules and vegetation modules. It creates inputs for initBaseMaps module, which is required for some fire modules and LW_LBMRDataPrep module which is used by LBMR (Landis Biomass Succession Module in R).
...
modules <- list("landWebDataPrep", "initBaseMaps", "LandMine", "LW_LBMRDataPrep", "LBMR", "timeSinceFire", "LandWebOutput")
