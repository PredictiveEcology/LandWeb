...
test_dir("C:/Users/jemar270/Documents/GitHub/LandWeb/m/Boreal_FireSenseDataPrep/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/jemar270/Documents/GitHub/LandWeb/m/Boreal_FireSenseDataPrep/tests/testthat/test-template.R")
