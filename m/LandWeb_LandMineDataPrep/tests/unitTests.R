...
test_dir("/home/emcintir/Documents/GitHub/LandWeb/m/LandWeb_LandMineDataPrep/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/home/emcintir/Documents/GitHub/LandWeb/m/LandWeb_LandMineDataPrep/tests/testthat/test-template.R")
