...
doEvent.LandWeb_LandMineDataPrep = function(sim, eventTime, eventType) {
  switch(
    ...
    init = {
      ...
      sim <- scheduleEvent(sim, P(sim)$.plotInitialTime, "LandWeb_LandMineDataPrep", "plot")
      sim <- scheduleEvent(sim, P(sim)$.saveInitialTime, "LandWeb_LandMineDataPrep", "save")
    },
    plot = {
      # ! ----- EDIT BELOW ----- ! #
      # do stuff for this event
      ...
      # e.g.,
      #sim <- scheduleEvent(sim, time(sim) + P(sim)$.plotInterval, "LandWeb_LandMineDataPrep", "plot")
    ...
    save = {
      ...
      # e.g.,
      # sim <- scheduleEvent(sim, time(sim) + P(sim)$.saveInterval, "LandWeb_LandMineDataPrep", "save")
    ...
    event1 = {
      ...
      # e.g.,
      # sim <- scheduleEvent(sim, time(sim) + increment, "LandWeb_LandMineDataPrep", "templateEvent")
