...
# 2. Copy this file to the tests folder (i.e., `C:/Users/yonluo/Documents/GitHub/LandWeb/landWeb_LBMRDataPrep/tests/testthat`).

# 3. Modify the test description based on the content you are testing:
test_that("test Event1 and Event2.", {
  module <- list("landWeb_LBMRDataPrep")
  ...
  parameters <- list(
    ...
    landWeb_LBMRDataPrep = list(.saveInitialTime = NA)
  )
