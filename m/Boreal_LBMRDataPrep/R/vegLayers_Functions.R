...
makeStudyAreaMask <- function(ras, maskFilename, cache_path) {
  #ras[] <- ras[]
...
makePaulStack <- function(paths, Paul250MaskedFilename, uniqueKeepSp, ...) {
...
CASFRItoSpRasts <- function(cachePath, CASFRIRas, loadedCASFRI) {
  spRasts <- list()
