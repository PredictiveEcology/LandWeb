test_that("test update the outputs. ",{
  ...
  if(exists("updateOutputs")){
    simOutput <- updateOutputs(mySim, biomassMap, ANPPMap, mortalityMap, reproductionMap)
  } else {
    simOutput <- mySim$updateOutputs(mySim, biomassMap, ANPPMap, mortalityMap, reproductionMap)
  }
